    ...
    try:
        ...
        if analysis_type == 'detailed':
            try:
                ...
                system_prompt = """
                모든 참여 언론사의 기사를 반드시 빠짐없이 분석하여 다음 형식으로 정리해주세요:
                ...
                ※ 주의사항
                - 모든 참여 언론사를 빠짐없이 포함할 것
                - 구체적인 기사 내용과 표현을 인용하여 분석할 것
                - 중립적인 톤으로 작성할 것
                - 언론사별 중복 없이 분석할 것
                - 누락된 언론사가 있는지 마지막에 재확인할 것
                """
    ...
    for keyword_data in top_keywords:
        ...
        if related_articles:
            ...
            try:
                ...
                보도 관점 분석
                - [언론사명] (각 언론사별로 반드시 분석)
                  * 주요 보도 프레임과 논조 (긍정/부정/중립)
                  * 구체적인 표현과 인용구 포함
                  * 다룬 주요 이슈와 강조점

                주요 쟁점 분석
                - 쟁점 1: [쟁점명]
                  * 찬성/지지 언론사: [언론사명들] - 주요 논거
                  * 반대/비판 언론사: [언론사명들] - 주요 논거
                  * 중립 언론사: [언론사명들] - 보도 방식
