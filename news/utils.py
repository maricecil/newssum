...
stop_words = {
    ...
    # 17. 기타 명사
    '한정', '회수', '변명', '업무', '폄훼', '적절', '부적절', '감사', '뒤집힌', '역전', '부주석', '합창', '마무리', '오타', '역시', '파편들',
    '합류', '업무', '전략', '남발', '방역', '대담', '위력', '과시하', '축하', '아이', '가동', '재가동', '치부', '파티', '개사', '통화',
    '허공', '신의', '총장', '소집', '우정', '의견', '최종결정', '결정', '결단', '마음', '활주로', '추돌', '사랑', '날개', '필사', '연료', '진압', 
    '수도', '소득', '영웅', '활활', '돌연', '광기', '앞날', '직격', '추락', '피겨', '선수', '코치', '가족들', '선수들', '마치', '대회', 
    '탑승', '하차', '이탈', '하선', '시신', '동료',
}
