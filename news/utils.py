...
stop_words = {
    ...
    '사망', '생존', '부상', '사상', '희생', '희생자', '피해', '피해자', '정신', '불법', '적법', '합법',
    '변사', '타계', '별세', '운명', '서거', '사인', '장례', '추모', '거품', '품위', 
    '가짜', '사실', '허위', '진실', '실제', '메시지', '공문', '이름', '명칭', '배우',
    '측', '씨', '분들', '여러분', '맹공', '맞불', '설전', '폭로', '특종', '청도', '전국', '회의', 
    '삶', '여정', '자결', '자살', '죽음', '왜곡', '들통', '치명', '줄줄이', '논의', '고지', 
    '정계', '천상계', '잡지', '영상', '동영상', '발의', '제보', '서면', '마크',
    '소문', '동요', '사건', '불명', '자사', '회견', '서비스', '언론사', '실적', '명단', '역대급',
    '생존자', '사망자', '사고', '시신', '추락', '직격', '돌연',
    ...
    '성립', '규명', '돌변', '송금', '복귀', '휴정', '피력', '사유', '방만',
    '수호', '발동', '최우선', '우선', '옥중', '연장', '대선', '차기', '경선',
    '합류', '남발', '과시하', '축하', '가동', '재가동', '진압', '추돌', '탑승', '하차', '이탈', '하선',
    '한정', '회수', '변명', '폄훼', '합창', '마무리',
    ...
    '제동', '주소', '비번', '명의', '회전', '이적', '출도', '주차장',
    '강력', '오차범위', '덩달아', '업무', '전략', '방역', '대담',
    ...
    '사고원인', '정당성', '실질', '온전', '관계', '각각', '경호', '달인',
    '적절', '부적절', '감사', '뒤집힌', '역전', '우정', '마음', '사랑',
    '영웅', '유망', '허공', '신의', '광기', '앞날', '활활', '오타', '역시', '파편들', '치부', '파티', '개사', '통화', '연료',
    ...
    '급증', '지난해', '분산', '숫자', '확률', '중', '즉각', '내내', '별도',
    

    # 7. 법률/수사 관련
    '수사', '조사', '심사', '심의', '점검', '검토', '진술', '증언', '자백', '취조', '심판', '차기', '무죄', '말씀', '호소', 
    '심문', '조서', '소환', '체포', '구속', '압수', '수색', '혐의', '증거', '배상', '검사', '민원', '발부', '요원',
    '소송', '고소', '고발', '기소', '구형', '재판', '판결', '출석', '협박', '현직', '폭력',
    '흉기', '둔기', '무기', '총', '칼', '망치', '톱', '소총', '화살', '촉', '검열', '나랏돈', '눈먼돈', '거래', '원금', '액수',
    '집행', '대행', '이행', '강제', '명령', '처분', '처벌', '제재', '단속', '규제', '통제',
    '정족수', '호송', '조력자', '범인', '외압성', '본부장', '장관', '차장', '현직', '법리', '법치',
    '의원', '사장', '판사', '죄인', '회원', '친구', '우리', '갑부', '나라', '지법', '여야', '후보',
    ...
    '인근', '이역만리', '만리', '이역', '단역', '일역', '교육', '세계', '서부', '동부', '남부', '북부', '지하', '지상',

    # 10. 인물/주민 관련
    '시민', '도민', '군민', '구민', '주민', '국민', '민간인', '민족', '유가족', '유족', '그들', '이들', '저들', 
    '엄마', '아빠', '부모', '아버지', '어머니', '할머니', '할아버지', '손자', '손녀', '삼촌', '이모', '고모', '외삼촌',
    '조카', '사촌', '형', '누나', '오빠', '언니', '동생', '남매', '자매', '형제', '쌍둥이', '자녀', 
    '시어머니', '시아버지', '장인', '장모', '며느리', '사위', '시댁', '처가', '가족', '일가족', '일가', 
    '왕', '왕비', '공주', '왕자', '황제', '황후', '귀족', '공작', '백작', '후작', '남작', '군주', '하늘나라', '백설공주', '어린왕자', '인어공주',
    ...
    '여보', '멜라', '니아', '효자', '사나이', '장원', '표정', '양복', '방검복', '샤쓰', '승객', '이웃',
    '선수', '코치', '동료', '가족들', '선수들', '한국계', '탑승자', '전원', '남녀', '여자', '남자',
    ...
    '자기', '얘기', '고시', '비교', '면전', '홀로', '멀쩡', '동안', '다시', '혼자', '시속', '괴수',
